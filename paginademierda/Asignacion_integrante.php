...
while($consulta=mysqli_fetch_array($resultado)){
  ...
  $Estatus_aceptado=$consulta['Estatus'];
   $Gen=$consulta['Generación'];
}

/////////////TRAER EL ESTATUS DEL PROYECTO///////////////////////////////////
$resultado_estatus=mysqli_query($Conexion,"SELECT * FROM tacceso_lider WHERE  Matricula='$Matriculalider'");
while($consulta=mysqli_fetch_array($resultado_estatus)){
...
$resultado_materias_agregar=mysqli_query($Conexion,"SELECT * FROM carga_profesor WHERE Grupo='$Grupo1' and Estatus='Asignada'");
 ...
 echo '<script>';
          ...
          echo 'window.location.href="Asignacion_integrante.php";';
echo '</script>';
  ...
  echo '<script>';
          echo 'alert("Tienes que estar en un proyecto antes de agregar las materias");';
          echo 'window.location.href="Asignacion_integrante.php";';
echo '</script>';
...
$Agregar_BD="INSERT INTO carga(Nombre,Matricula,Matriculalider,Materia,Grupo,Profesor,P1,P2,P3)
          VALUES('$Nombre','$Matricula','$Matriculalider','$Materia','$Grupo','$Nombre_maestro','$P1','$P2','$P3')";
...
<link rel="stylesheet" href="css/assignacion_integrante.css">
...
<form  action="Asignacion_integrante.php" method="post">
<table class="Tabla">
<tr>
...
<div class="ventana_datos" id="vent" >
  <div class="cerrar" id="cerrar"> <a href="javascript:cerrar_agregar()"> <img src="Imagenes/cerrar.png"> </a></div>
    ...
    <form  method="post" action="Asignacion_integrante.php">
...
<form method="post" action="Proyecto_Integrador_Integrante.php">
<table class="Tabla">
<tr>
    <th style="text-align: center;">Materia</th>          <!--Codigo de los titulos de columnas-->
    <th style="text-align: center;">Grupo</th>
