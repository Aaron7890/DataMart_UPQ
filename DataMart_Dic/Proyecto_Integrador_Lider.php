...
<div class="ventana_datos" id="vent" >
  <div class="cerrar" id="cerrar"> <a href="javascript:cerrar()"> <img src="Imagenes/cerrar.png"> </a></div>
    ...
    <label style="font-family: calibri;font-size: 13px;"> <strong>Tutor</strong></label>
    <br>
    <textarea class="agregar_datos" style="width:80%; height: 80px;font-family:calibri" name="Tutor"></textarea>
    <br>
