...
if ($_POST['Opcion']=='Profesor'){    


$Usuario=trim($_POST['Correoelectronico']);
$Contraseña=trim($_POST['Contraseña']);
//Cosultar  a la base de datos Profesores
//Prtoducción: $Conexion=mysqli_connect("localhost","jquintana","wS717714CU","bdpintegrador");

$Conexion=mysqli_connect("localhost","root","","bdpintegrador");

$Consulta="SELECT * FROM maestros WHERE Clave='$Contraseña' and Correo='$Correoelectronico'";
...
else{  //else que verifica ahora si se presiono el boton de tutor 
session_start();
if ($_POST['Opcion']=='Tutor'){   
...
$Consulta="SELECT * FROM maestros WHERE  Clave='$Contraseña' and Usuario='$Usuario_notutor'";
$resultado=mysqli_query($Conexion,$Consulta);
$filas=mysqli_num_rows($resultado);
